...
public class OrderBusinessFinishAdapter extends ArrayAdapter<OrderBean> {


    private List<OrderBean> list;


    public OrderBusinessFinishAdapter(@NonNull Context context, List<OrderBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        LinearLayout button =convertView.findViewById(R.id.finish_order_button);//取消顶订单
