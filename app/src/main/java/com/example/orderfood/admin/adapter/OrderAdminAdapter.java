...
public class OrderAdminAdapter extends ArrayAdapter<OrderBean> {


    private List<OrderBean> list;


    public OrderAdminAdapter(@NonNull Context context, List<OrderBean> list) {
        super(context, R.layout.admin_order_list, list);
        this.list=list;
    }
...
//        userName.setText(orderBean.getS_order_user_name());
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //订单的状态更新为 "4",即“管理员取消的”
                OrderDao.updateOrder( orderBean.getS_order_id(),"4");
